#======================================================================================================================
#   Entity extraction based on Regex specified in Config xml
#
#   Refernce: http://www.kdnuggets.com/2017/05/text-mining-information-resume.html
#   Code: https://github.com/yogeshhk/MiningResume
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 3:
        print("Usage: config_engine <configfile> <datafilesfolder>")
        sys.exit(0)
